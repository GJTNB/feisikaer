...
#define LCD_SCL PTE9_OUT  //K60的管脚配置
#define LCD_SDA	PTE8_OUT
#define LCD_RST PTE7_OUT 
...
//  for(i=0;i<=119;i++){
//    for(j=0;j<=159;j++){
//      img_1[i][   (uint8)((j-80)/(1+((285.0f/52.0f)-1)*i/119.0f)+80)   ]=img[i][j];
//      //img_1[i][  (uint8)((j-80)*(80-i*60/119.0f)/80.0f +80)  ]=img[i][j];
//    }
//  }
